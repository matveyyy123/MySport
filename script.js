const workoutsData = {
    ...
    abs: {
        name: "ПРЕСС",
        time: "20 минут",
        exercisesCount: "8 упражнений",
        heroImg: "images/abs.jpg",
        exercises: [
            { name: "Скручивания", reps: "3x12" },
            { name: "Обратные скручивания", reps: "3x12" },
            { name: "Подъем ног в висе", reps: "3x12" },
            { name: "Планка", reps: "3x12" },
            { name: "Велосипед", reps: "3x12" },
            { name: "Боковые скручивания", reps: "3x12" },
            { name: "Русский твист", reps: "3x12" },
            { name: "Вакуум живота", reps: "3x12" }
        ]
    }
};
